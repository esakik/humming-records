                ...
                <div class="panel-body">
                    <c:choose>
                        ...
                        <c:otherwise>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <div class="price">
                                                    <span><fmt:formatNumber value="${orderItem.itemInfo.price}" pattern="###,###" /></span> <font style="color: red; margin-right: 15px;">円</font><br>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 purchase">
                                <div>
